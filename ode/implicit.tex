...
\end{Theorem}
 ...
 \begin{remark}
	The term of A-stability was deliberately chosen neutrally by Dahlquist
	since he considered notions with a rather extravagant choice of words as outworn.
	Note that A-stability does not stand for asymptotic stability. The notion
	of B-stability which we will consider later on was introduced by John
	Butcher. He not only managed to find the perfect moment to introduce this new notion,
	but also to get his name once again into the realm of mathematics.
 \end{remark}
