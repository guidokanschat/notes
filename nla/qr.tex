...
\begin{remark}
  \slideref{Algorithm}{subspace-iteration} requires the choice of initial vectors. In principle, any choice of a linearly independent set $\matx_0$ is ok. But, in particular when all eigenvalues are desired, there is a special choice, which are the columns of $\mata$. This leads to the QR iteration.
\end{remark}
