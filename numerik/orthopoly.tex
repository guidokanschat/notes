...
\begin{proof}
 ...
 \glqq $\Rightarrow$\grqq{}:
  ...
  und es gilt
  \begin{gather}
    0 = \left. \frac{d}{dx} F(x) \right|_{x=0} =  2 \scal(u-u_b,xv).
  \end{gather}

  \grqq$\Leftarrow$\grqq{}:
  Erfülle nun $u_b\in A$ die Bedingung $\scal(u-u_b,xv) = 0$ für alle $v\in W$.
  \begin{align}
    \norm{u-u_b}^{2}
    &=\scal(u-u_b,u-u_b)\\
    &= \scal(u-u_b,u-u_b-v)\\
