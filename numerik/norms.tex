...
\begin{Definition}{eigenwert}
  ...
  \begin{gather}
    Av = \lambda v,
  \end{gather}
  so nennen wir $\lambda$ \define{Eigenwert} von $A$ und $v$ einen
...
\begin{Definition}{matrix-kondition}
  Die \define{Konditionszahl} der Matrix $A$ zur Norm $\norm{\cdot}$ ist das Produkt
  \begin{gather}
    \cond(A) = \norm{A} \,\norm{A^{-1}}
  \end{gather}
  Insbesondere definieren wir die \define{Spektralkondition} einer
  s.p.d. Matrix als
  \begin{gather}
