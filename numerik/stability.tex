...
\begin{Beispiel*}{algorithmuseigenschaften}{Eigenschaften von Algorithmen}
  \begin{description}
...
\begin{remark}
  ...
  FLOP, deren zeitliche Abfolge nicht determiniert ist. Dies steht
  wegen der fehlenden Assoziativität im Widerspruch zu
