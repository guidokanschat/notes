...
\begin{proof}
  ...
  \end{gather}
  Therefore, the first $r$ vectors of V span the range of $A^\transpose$ and
...
\begin{Corollary}{svd-infsup}
  ...
  \begin{gather}
    \label{eq:infsup:6}
    \sigma_r
    = \inf_{v\in \ortho{\ker A}} \sup_{w\in \R^m} \frac{w^\transpose A v}{\abs{v}\abs{w}}
    = \inf_{w\in \ortho{\ker{A^\transpose}}} \sup_{v\in \R^n} \frac{w^\transpose A v}{\abs{v}\abs{w}}.
  \end{gather}
\end{Corollary}
...
\begin{proof}
  ...
  \begin{gather}
    \sup_{w\in\R^m}\frac{w^\transpose A v}{\abs{w}} = \frac{v^\transpose A^\transpose A v}{\abs{Av}}.
  \end{gather}
  Therefore,
  \begin{gather}
    \inf_{v\in \ortho{\ker A}} \sup_{w\in \R^m}
    \frac{w^\transpose A v}{\abs{v}\abs{w}}
