...
\begin{remark}
  \blockref{Corollary}{infsup-well-posedness1} exhibits an asymmetry
...
\begin{Problem}{inhomogeneous-continuity}
  Show that \blockref{Theorem}{infsup-mixed2} can be extended to the
...
\begin{solution}
  ...
  \begin{enumerate}
  \item Due to \blockref{Theorem}{infsup-well-equivalence}, the
...
\begin{Theorem}{mixed-stabilized-well-posed}
  Let \blockref{Assumption}{mixed-elliptic-stabilized} hold and
...
\begin{intro}
  The extension of \blockref{Theorem}{galerkin-mixed-p} to the
  saddle-point problem of \blockref{Definition}{saddle-point-abstract}
...
\begin{Corollary}{mixed-residual-bounded}
  Under \blockref{Assumption}{mixed-elliptic-stabilized}, we have
  \begin{gather}
    \begin{split}
      \abs{R_f(v_h)}
      &\le \bigl(\norm a \norm{u-w_h}_V + \norm b \norm{p-r_h}\bigr)
...
\begin{Lemma}{stabilized-mixed-approximation}
  ...
  \blockref{Theorem}{mixed-stabilized-well-posed} hold. Then, there
...
\begin{proof}
  ...
  well-posedness for
  \blockref{Theorem}{mixed-stabilized-well-posed}. It is obtained by
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \norm{p-p_h} &\le \norm{p-q_h} + \norm{q_h-p_h}.
  \end{align*}
  Then, we employ \blockref{Lemma}{stabilized-mixed-approximation} on
  the terms on the right and use the estimate of
  \blockref{Corollary}{mixed-residual-bounded}.
\end{proof}
