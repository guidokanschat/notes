...
\begin{remark}
  ...
  abstract way. Depending on $a(.,.)$ we can fomulate two conditions:
  ...
  assumption.  In these cases, not that $V$-ellipticity already
...
\begin{solution}
  ...
  \item Due to \blockref{Theorem}{infsup-well-equivalence}, the
    ...
    \end{gather*}
  \item The function $u_0 = u-u_g$ solves a problem as in
