...
\begin{proof}
  ...
  from \blockref{Lemma}{k-plus-d}. The vertical identities from the
...
%   \begin{gather}
%     \begin{array}{c|ccc}
%       \dim f & H^1 & \Hcurl & \Hdiv \\\hline
%       3 & \P_{r-4}\Lambda^3 & \P_{r-2}\Lambda^2 & \P_{r-1}\Lambda^1 \\
%       2 & \P_{r-3}\Lambda^2 & \P_{r-1}\Lambda^1 & \P_{r}\Lambda^0 \\
%       1 & \P_{r-2}\Lambda^1 & \P_{r}\Lambda^0 & \\
%       0 & \R & &
%     \end{array}
%   \end{gather}
% \end{Example}
...
\section{The complex of tensor products}
