...
\subsection{Definition and unisolvence}
...
\begin{proof}
  ...
  \slideref{Lemma}{darcy-infsup}, we realize that the velocity was
...
\begin{Notation}{recap-reference-transform}
  ...
  define the \define{Jacobi matrix}, the \define{Jacobi determinant},
  and the \define{face Jacobian} (suppreccing the index $\cell$)
  \begin{gather}
...
\begin{Corollary}{darcy-convergence-affine}
  \slideref{Theorem}{darcy-quasi-best} applies to quadrilateral and
  ...
  \slideref{Corollary}{darcy-convergence} hold.
\end{Corollary}
