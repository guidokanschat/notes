...
\begin{Example}{rt-simplex}
  ...
  \begin{center}
    \begin{tabular}{c@{\hspace{.05\textwidth}}c@{\hspace{.05\textwidth}}c}
      \includegraphics[width=.28\textwidth]{./fig/rt0-tri.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/rt1-tri.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/rt2-tri.tikz}
      \\[5mm]
      \includegraphics[width=.28\textwidth]{./fig/p0-p.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/dgp1-p-tri.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/dgp2-p-tri.tikz}
    \end{tabular}
  \end{center}
\end{Example}
...
\begin{Example}{bdm-simplex}
  ...
  \begin{center}
    \begin{tabular}{c@{\hspace{.2\textwidth}}c}
      \includegraphics[width=.3\textwidth]{./fig/bdm1-tri.tikz}
      &
      \includegraphics[width=.3\textwidth]{./fig/bdm2-tri.tikz}
      \\[5mm]
      \includegraphics[width=.3\textwidth]{./fig/p0-p.tikz}
      &
      \includegraphics[width=.3\textwidth]{./fig/dgp1-p-tri.tikz}
    \end{tabular}
  \end{center}
\end{Example}
...
\begin{Example}{rt-quad}
  ...
  \begin{center}
    \begin{tabular}{c@{\hspace{.05\textwidth}}c@{\hspace{.05\textwidth}}c}
      \includegraphics[width=.28\textwidth]{./fig/rt0-quad.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/rt1-quad.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/rt2-quad.tikz}
      \\[5mm]
      \includegraphics[width=.28\textwidth]{./fig/q0-p.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/dgq1-p.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/dgq2-p.tikz}
    \end{tabular}
  \end{center}
\end{Example}
...
\begin{Example}{bdm-quad}
  ...
  \begin{center}
    \begin{tabular}{c@{\hspace{.05\textwidth}}c@{\hspace{.05\textwidth}}c}
      \includegraphics[width=.28\textwidth]{./fig/bdm1-quad.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/bdm2-quad.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/bdm3-quad.tikz}
      \\[5mm]
      \includegraphics[width=.28\textwidth]{./fig/q0-p.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/q-p1-p.tikz}
      &
      \includegraphics[width=.28\textwidth]{./fig/q-p2-p.tikz}
    \end{tabular}
  \end{center}
\end{Example}
