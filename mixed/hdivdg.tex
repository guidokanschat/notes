...
\begin{Theorem}{hdivdg-l2}
  Let the assumptions of \blockref{Theorem}{hdivdg-convergence}
  and \blockref{Assumption}{stokes-regularity} hold. Then,
  \begin{gather}
...
\begin{Problem}{hdivdg-l2}
  Adapt the proof of \blockref{Theorem}{ip-lifting-l2} to prove
  \blockref{Theorem}{hdivdg-l2}.
\begin{solution}
  ...
  For the third term we use \blockref{Lemma}{ip-lifting-residual-2}
  to obtain
  \begin{gather*}
  ...
  \end{align*}
  This is excatly the same prrof we used before.
