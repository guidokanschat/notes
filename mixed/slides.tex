...
\frame {\input {blocks/Definition-momentum-dofs-qk-2d.tex}}
\frame {\input {blocks/Definition-momentum-dofs-qk-3d.tex}}
\frame {\input {blocks/Example-qk-pk1.tex}}

\subsection{The macro element technique}
...
\frame {\input {blocks/Lemma-macro-projection.tex}}
\frame {\input {blocks/Lemma-macro-constant.tex}}
\frame {\input {blocks/Problem-P.tex}}
\frame {\input {blocks/Theorem-macroelement.tex}}
