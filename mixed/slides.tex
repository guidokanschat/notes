...
\begin{frame}
  \begin {blocktheorem}{Example: Raviart-Thomas elements}
  The first members of the Raviart-Thomas family on triangles are
  \begin{center}
    \begin{tabular}{c@{\hspace{.2\textwidth}}c}
      \includegraphics[width=.2\textwidth]{./fig/rt0-tri.tikz}
      &
      \includegraphics[width=.2\textwidth]{./fig/rt1-tri.tikz}
      \\[5mm]
...
\begin{frame}
  \begin {blocktheorem}{Example: BDM elements}
  The first members of the BDM family on triangles are
  \begin{center}
    \begin{tabular}{c@{\hspace{.2\textwidth}}c}
      \includegraphics[width=.2\textwidth]{./fig/bdm1-tri.tikz}
      &
      \includegraphics[width=.2\textwidth]{./fig/p0-p.tikz}
      \\[5mm]
      \includegraphics[width=.2\textwidth]{./fig/bdm2-tri.tikz}
      &
      \includegraphics[width=.2\textwidth]{./fig/dgp1-p-tri.tikz}
    \end{tabular}
  \end{center}
\end {blocktheorem}
...
\frame {\input {blocks/Problem-Piola-transform-integrals.tex}}
