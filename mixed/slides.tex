...
\frame {\input {blocks/Problem-darcy-derham.tex}}
...
\frame {\input {blocks/Lemma-d-kappa-injective.tex}}
\frame {\input {blocks/Theorem-polynomial-exact.tex}}
\frame {\input {blocks/Corollary-pk-complexes.tex}}
...
\frame {\input {blocks/Definition-spanned-simplex.tex}}
\frame {\input {blocks/Definition-subsimplices.tex}}
\frame {\input {blocks/Definition-pr-f.tex}}
\frame {\input {blocks/Lemma-subsimplex-polynomials.tex}}
\frame {\input {blocks/Problem-subsimplex-polynomials.tex}}
\frame {\input {blocks/Example-h1-moment-dofs.tex}}
\frame {\input {blocks/Definition-v-of-f.tex}}
\frame {\input {blocks/Definition-w-of-f.tex}}
