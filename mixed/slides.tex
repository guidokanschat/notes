...
\frame {\input {blocks/Definition-dg-spaces.tex}}
...
\frame {\input {blocks/Problem-ip-norm.tex}}
\frame {\input {blocks/Lemma-ip-stability.tex}}
\frame {\input {blocks/Problem-ip-stability.tex}}
