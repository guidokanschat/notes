...
\begin{proof}
  ...
  cover the whole mesh, such that we can use \blockref{Lemma}{macro1}
  and \blockref{Lemma}{verfuerth2} to prove the inf-sup condition.
...
\begin{intro}
  ...
  In view of \blockref{Theorem}{galerkin-mixed-u-kerbh}, locking means
  ...
  in\blockref{Theorem}{galerkin-mixed-p} on the other hand guarantees
...
\begin{proof}
  ...
  form $c(.,.)$, such that
  \blockref{Theorem}{mixed-stabilized-well-posed} and
  \blockref{Corollary}{stabilized-mixed-convergence} apply.
\end{proof}
