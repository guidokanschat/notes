...
\begin{proof}
  ...
  macroelement $M$. Applying \blockref{Lemma}{macro-local}, for each
...
\begin{Problem}{macroelement-constant}
  Prove \blockref{Lemma}{macro-constant}
\end{Problem}

\begin{Theorem}{macroelement}
  Let the assumptions of \blockref{Lemma}{macro-projection}
  hold. Then, the pair $V_h\times Q_h$ is inf-sup stable.
\end{Theorem}

\begin{proof}
  Let $q_h\in Q_h$. Then, applying \blockref{Lemma}{macro-projection}
  and \blockref{Lemma}{macro-constant}, we obtain functions $v_h$ and
