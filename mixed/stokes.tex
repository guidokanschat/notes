...
\begin{remark}
  ...
  Not that we have established already in
...
\begin{proof}
  ...
  \begin{gather*}
    \scal(-\nabla p, v)_{V^*\times V} = \scal(p, div
    v)_{L^2(\domain)},
    \qquad\forall v\in V,
  \end{gather*}
...
\begin{Theorem}{stokes-convergence}
  Let $V=H^1_0(\domain;\R^d)$ and $Q=L^0_0(\domain)$. Let furthermore
  ...
  \begin{gather}
    ...
    \begin{split}
      \norm{u-u_h}_1
      &\le c_1 \inf_{v_h\in V_h}{u-v_h}_1
      + c_2 \inf_{q_h\in Q_h}{p-q_h}_0
      \\
      \norm{p-p_h}_1
      &\le c_3 \inf_{v_h\in V_h}{u-v_h}_1
      + c_4 \inf_{q_h\in Q_h}{p-q_h}_0.
    \end{split}
  \end{gather}
\end{Theorem}

\begin{Corollary}{stokes-convergence2}
  Under the assumptions of \blockref{Theorem}{stokes-convergence2},
