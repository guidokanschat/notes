    ...
    \begin{columns}
      \begin{column}{.54\textwidth}
        ...
        \visible<2>{
          \begin{gather*}
            V_{\mesh} = S^{1,1}(\mesh)
            = \bigl\{ v\in H^1(\domain) \;\big|\; \forall T\in\mesh : v_{|T} \in \P_1\bigr\}
          \end{gather*}
          }
      \end{column}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Local properties of a finite element}
\frame{\subtoc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Global properties of finite elements}
\frame{\subtoc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {\input{blocks/Definition-node-topology.tex}}
\frame {\input{blocks/Example-nodes-identification.tex}}
\frame {\input{blocks/Problem-counting-dofs.tex}}
...
\frame {\input {blocks/Definition-Galerkin-equations.tex}}
...
\begin{frame}{Smoothing property of the Gauss-Seidel iteration}
    ...
    \begin{column}{.45\textwidth}
      \begin{flushright}
        step 0
        \includegraphics[width=.6\textwidth]{../graph/smoothing/gauss-seidel-0.tikz}

        step 1
        \includegraphics[width=.6\textwidth]{../graph/smoothing/gauss-seidel-1.tikz}
        
        step 2
        \includegraphics[width=.6\textwidth]{../graph/smoothing/gauss-seidel-2.tikz}
      \end{flushright}
    \end{column}
    \begin{column}{.45\textwidth}
      \pause
      \begin{center}
        \includegraphics[width=.6\textwidth]{../graph/smoothing/gauss-seidel-3.tikz}
        
        steps 3,4,5
        
        \pause
        \includegraphics[width=.6\textwidth]{../graph/smoothing/gauss-seidel-4.tikz}
