...
\begin{Definition}{bilinear-form}
  ...
  arguments. The bilinear form is \textbf{bounded}, if
  \begin{gather}
    a(u,v) \le \norm{u}_V \norm{v}_V, \qquad \forall u,v\in V.
  \end{gather}
  It is called \define{coercive} or \define{elliptic}, if
  \begin{gather}
...
\begin{Lemma*}{lax-milgram}{Lax-Milgram}
  Let $a(.,.)$ be a coercive bilinear form on a Hilbert space $V$ and
  let $f \in V^*$. Then, there is a unique element $u\in V$ such that
  \begin{gather}
