\begin{intro}
 ...
 solvability of PDEs in Hilbert spaces. This will lead us to
  ...
  with \slideref{Lemma}{weak-well-posed}.
\end{intro}
...
\begin{proof}
  ...
  Then, there holds
  \begin{align*}
    (\mathbf A(x) \nabla u,\nabla v)_{L^2} = \int_\domain\mathbf A(x) \nabla u\cdot \nabla u \dx \overset{~\mathclap{\eqref{eq:hilbert:semi-elliptic}}~}{\geq} \alpha \int_\domain \abs{\nabla u}^2 \dx = \alpha \norm{\nabla u}_{L^2}^2 = \alpha \abs{u}_1^2.
  \end{align*}
