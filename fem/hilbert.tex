...
\begin{proof}
  To proof Lax-Milgram we first consider the uniqueness and then the existence of the solution $u$.

  Assume that there are solutions $u_1$ and $u_2$ of \eqref{eq:hilbert:lax-milgram}
\end{proof}
